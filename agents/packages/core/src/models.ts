...
export const models: Models = {
    ...
    [ModelProviderName.FUNCTION]: {
        endpoint: "https://api.function.network/v1",
        model: {
            [ModelClass.SMALL]: {
                name:
                    settings.SMALL_FUNCTION_MODEL ||
            ...
            [ModelClass.MEDIUM]: {
                name:
                    settings.MEDIUM_FUNCTION_MODEL ||
                    "meta/llama-3.1-70b-instruct",
                stop: [],
                maxInputTokens: 128000,
                maxOutputTokens: 8192,
            ...
            [ModelClass.EMBEDDING]: {
                name:
                    settings.EMBEDDING_FUNCTION_MODEL ||
                    "baai/bge-large-en-v1.5",
                dimensions: 1536,
            },
            [ModelClass.IMAGE]: {
                name:
                    settings.IMAGE_FUNCTION_MODEL ||
